...
const els = {
  ...
  settingsForm: document.querySelector("#settingsForm"), summaryEmail: document.querySelector("#summaryEmail"), sheetsUrl: document.querySelector("#sheetsUrl"), installBtn: document.querySelector("#installBtn"), refreshBtn: document.querySelector("#refreshBtn"),
